...
import com.demo.spring.controller.EmpRestURIConstants;
import com.demo.spring.model.Employee;

public class TestSpringRestExample {

	public static final String SERVER_URI = "http://localhost:8080/SpringRestExample/employees";
	...
	private static void testCreateEmployee() {
		...
		emp.setId(1);emp.setName("Brahmaiah Doma");
